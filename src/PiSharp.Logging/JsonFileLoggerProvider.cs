...
/// </summary>
public sealed class JsonFileLoggerProvider : RollingFileLoggerProvider
{
    ...
    public override void Write<TState>(string category, LogLevel logLevel, EventId eventId, TState state, Exception? exception, Func<TState, Exception?, string> formatter)
    {
