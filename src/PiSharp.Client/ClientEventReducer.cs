...
public static class ClientEventReducer
{
    public static ClientSessionState Apply(ClientSessionState state, ServerEventEnvelope envelope)
    {
        ...
        return evt.Type switch
        {
            ...
            "agent_start" => state with { IsBusy = true, Status = "Working...", LastAppliedSequence = seq },
            "turn_start" => state with { IsBusy = true, Status = "Working...", LastAppliedSequence = seq },
            "turn_end" => state with { IsBusy = false, Status = "Idle", LastAppliedSequence = seq },
