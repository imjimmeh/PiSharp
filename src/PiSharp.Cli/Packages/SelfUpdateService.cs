...
public sealed class SelfUpdateService
{
    ...
    public async Task PrintDaemonNoticeAsync(string? leasePath, IConsoleIO console, CancellationToken cancellationToken)
        => await PrintDaemonNoticeAsync(leasePath, console.Out, cancellationToken);
